...
import app.new.providers.base


class StructureTestSuite(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        cls.MODULE = app.new.providers.base
    
    def test_class_exists_basesmsprovider(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b'QmFzZVNtc1Byb3ZpZGVy').decode(),
            classes,
            msg=f"The class "
                f"`{base64.b64decode(b'QmFzZVNtc1Byb3ZpZGVy').decode()}` "
                f"is not found, but it was marked as required."
        )
        
    def test_class_function_exists_basesmsprovider__prepare_payload(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b'QmFzZVNtc1Byb3ZpZGVy').decode(),
            classes,
        ...
        self.assertIn(
            base64.b64decode(b'QmFzZVNtc1Byb3ZpZGVyLl9wcmVwYXJlX3BheWxvYWQ=').decode(),
            functions,
            msg=f"The function "
                f"`{base64.b64decode(b'QmFzZVNtc1Byb3ZpZGVyLl9wcmVwYXJlX3BheWxvYWQ=').decode()}` "
                f"is not found in class "
                f"`{base64.b64decode(b'QmFzZVNtc1Byb3ZpZGVy').decode()}`, "
                f"but it was marked as required."
        )
        
    def test_class_function_signature_match_basesmsprovider__prepare_payload(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b'QmFzZVNtc1Byb3ZpZGVy').decode(),
            classes,
    ...
    def test_class_function_exists_basesmsprovider__process_response(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b'QmFzZVNtc1Byb3ZpZGVy').decode(),
            classes,
        ...
        self.assertIn(
            base64.b64decode(b'QmFzZVNtc1Byb3ZpZGVyLl9wcm9jZXNzX3Jlc3BvbnNl').decode(),
            functions,
            msg=f"The function "
                f"`{base64.b64decode(b'QmFzZVNtc1Byb3ZpZGVyLl9wcm9jZXNzX3Jlc3BvbnNl').decode()}` "
                f"is not found in class "
                f"`{base64.b64decode(b'QmFzZVNtc1Byb3ZpZGVy').decode()}`, "
                f"but it was marked as required."
        )
        
    def test_class_function_signature_match_basesmsprovider__process_response(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b'QmFzZVNtc1Byb3ZpZGVy').decode(),
            classes,
    ...
    def test_class_function_exists_basesmsprovider_send(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b'QmFzZVNtc1Byb3ZpZGVy').decode(),
            classes,
        ...
        self.assertIn(
            base64.b64decode(b'QmFzZVNtc1Byb3ZpZGVyLnNlbmQ=').decode(),
            functions,
            msg=f"The function "
                f"`{base64.b64decode(b'QmFzZVNtc1Byb3ZpZGVyLnNlbmQ=').decode()}` "
                f"is not found in class "
                f"`{base64.b64decode(b'QmFzZVNtc1Byb3ZpZGVy').decode()}`, "
                f"but it was marked as required."
        )
        
    def test_class_function_signature_match_basesmsprovider_send(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b'QmFzZVNtc1Byb3ZpZGVy').decode(),
            classes,
